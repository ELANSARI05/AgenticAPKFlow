...
public abstract class CastRemoteDisplayLocalService extends Service {
    ...
    private Notification zzN(boolean z) {
        ...
        Notification build = new NotificationCompat.Builder(this).setContentTitle(str).setContentText(TextUtils.isEmpty(str2) ? getString(i, new Object[]{this.zzRh.getFriendlyName()}) : str2).setContentIntent(this.zzRe.zzRv).setSmallIcon(i2).setOngoing(true).addAction(android.R.drawable.ic_menu_close_clear_cancel, getString(com.google.android.gms.R.string.cast_notification_disconnect), zzlm()).build();
