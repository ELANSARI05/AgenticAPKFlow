...
public class Credential implements SafeParcelable {
    ...
    public Credential(int version, String internalCredentialId, String internalServerContext, String id, String name, Uri profilePictureUri, List<IdToken> idTokens, String password, String accountType) {
        this.zzCY = version;
