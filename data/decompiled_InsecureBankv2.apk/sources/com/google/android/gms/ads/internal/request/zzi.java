...
public interface zzi extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzi {
        ...
        public static zzi zzU(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzi)) ? new C0015zza(iBinder) : (zzi) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    AdResponseParcel zze = zze(data.readInt() != 0 ? AdRequestInfoParcel.CREATOR.createFromParcel(data) : null);
