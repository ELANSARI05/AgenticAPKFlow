...
public interface zzco extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzco {
        ...
        public static zzco zzw(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzco)) ? new C0077zza(iBinder) : (zzco) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 6:
                    ...
                    zzck zzdy = zzdy();
                    reply.writeNoException();
                    reply.writeStrongBinder(zzdy != null ? zzdy.asBinder() : null);
                    return true;
                case 7:
                    data.enforceInterface("com.google.android.gms.ads.internal.formats.client.INativeAppInstallAd");
                    String zzdz = zzdz();
