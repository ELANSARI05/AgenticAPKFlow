...
public final class GooglePlayServicesUtil {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            ...
            ?? zzbN2 = zzkz.zzbN(packageInfo.versionCode);
            if (zzbN2 < zzbN) {
    ...
    private static void zza(int i, Context context, String str) {
        ...
        if (zzkz.zzai(context)) {
            ...
            if (zzlk.zzoR()) {
                Notification.Builder autoCancel = new Notification.Builder(context).setSmallIcon(android.R.drawable.stat_sys_warning).setContentTitle(zzi).setContentText(zzc).setContentIntent(errorPendingIntent).setTicker(string).setAutoCancel(true);
                if (zzlk.zzoY()) {
