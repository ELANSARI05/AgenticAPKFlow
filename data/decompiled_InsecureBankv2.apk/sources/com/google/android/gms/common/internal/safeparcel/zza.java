...
public class zza {
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        int zza = zza(parcel, i);
        if (zza != i2) {
            throw new C0036zza("Expected size " + i2 + " got " + zza + " (0x" + Integer.toHexString(zza) + ")", parcel);
        }
    }
    ...
    public static int zzab(Parcel parcel) {
        ...
        int dataPosition = parcel.dataPosition();
        if (zzbA(zzaa) != 20293) {
            throw new C0036zza("Expected object header. Got 0x" + Integer.toHexString(zzaa), parcel);
        }
        int i = dataPosition + zza;
        if (i < dataPosition || i > parcel.dataSize()) {
            throw new C0036zza("Size read is invalid start=" + dataPosition + " end=" + i, parcel);
        }
        return i;
    }
