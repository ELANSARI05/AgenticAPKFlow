...
public interface zzg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzg {
        ...
        /* loaded from: classes.dex */
        public static class C0213zza implements zzg {
        ...
        public static zzg zzcN(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzg)) ? new C0213zza(iBinder) : (zzg) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 4:
                    ...
                    reply.writeNoException();
                    reply.writeInt(isUnderground ? 1 : 0);
                    return true;
                case 5:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    boolean zzb = zzb(zzcN(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeInt(zzb ? 1 : 0);
                    return true;
                case 6:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
