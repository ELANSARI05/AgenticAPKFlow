...
public interface zzd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzd {
        ...
        public static zzd zzci(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzd)) ? new C0189zza(iBinder) : (zzd) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    reply.writeStrongBinder(zzf != null ? zzf.asBinder() : null);
                    return true;
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IInfoWindowAdapter");
                    com.google.android.gms.dynamic.zzd zzg = zzg(zzi.zza.zzcP(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeStrongBinder(zzg != null ? zzg.asBinder() : null);
                    return true;
                case 1598968902:
