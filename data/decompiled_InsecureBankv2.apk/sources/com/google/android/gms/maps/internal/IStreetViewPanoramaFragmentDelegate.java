...
public interface IStreetViewPanoramaFragmentDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IStreetViewPanoramaFragmentDelegate {
        ...
        public static IStreetViewPanoramaFragmentDelegate zzcH(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IStreetViewPanoramaFragmentDelegate)) ? new C0184zza(iBinder) : (IStreetViewPanoramaFragmentDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 4:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    com.google.android.gms.dynamic.zzd onCreateView = onCreateView(zzd.zza.zzbg(data.readStrongBinder()), zzd.zza.zzbg(data.readStrongBinder()), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
